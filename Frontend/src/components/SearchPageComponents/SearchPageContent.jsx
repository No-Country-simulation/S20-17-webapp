        ...
        <>
            <div className="relative mx-auto flex w-2/4 flex-col items-center justify-center">
                ...
                <input
                    ...
                    id="hero-field"
                    name="hero-field"
                    className="mx-auto w-1/2 px-3 py-2 border-avanti-black focus:border-avanti-light-green focus:ring-avanti-light-green mb-3 rounded-2xl border p-3 focus:outline-none focus:ring-2"
                    value={searchQuery}
